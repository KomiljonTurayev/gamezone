(() => {
  ...
  const TRANSLATIONS_DATA = {
    ...
    "howToPlay": {
      ...
      "rain-tap":       { "uz": "Ekranga bosib to'lqinlar hosil qiling — yomg'ir bilan dam oling! 🌧️", "ru": "Нажимай на экран, чтобы создавать волны — расслабься под дождём! 🌧️", "en": "Tap the screen to create ripples — relax in the rain! 🌧️" },
